HOLOLIVE_JP = [
    ...
    ['UUFTLzh12_nrtzqBPsTCqenA', 'UULbtM3JZfRTg8v2KGag-RMw'], # Aki Rosenthal
    ...
    ['UU1suqwovbL1kzsoaZgFZLKg', 'UUp3tgHXw_HI0QMk1K8qh3gQ'], # Yuzuki Choco
    ['UUvzGlP9oQwU--Y0r9id_jnA'], # Oozora Subaru
    # Gamers
    ...
    ['UUIBY1ollUsauvVi4hW4cumw'], # Sakamata Chloe
    ['UU_vMYWcDjmfdpH6r4TTn1MQ'], # Kazama Iroha
]
...
HOLOLIVE_EN = [
    ...
    ['UUoSrY_IQQVpmIRZ9Xf-y93g'], # Gawr Gura
    ['UUyl1z3jo3XHR1riLFKG5UAg'], # Watson Amelia
    # Project: HOPE
    ['UU8rcEBzJSleTkf_-agPM20g'], # IRyS
    # Council
    ['UUsUj0dszADCGbF3gNrQEuSQ'], # Tsukumo Sana
    ['UUO_aKKYxn4tvrqPjcTzZ6EQ'], # Ceres Fauna
